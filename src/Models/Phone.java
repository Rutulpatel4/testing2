...
public class Phone {
    ...
    public Phone(String make, String model, String os, String processor, String colour, double screenSize, double memory, double frontCamRes, double rearCamRes, double price, Image phoneImage) {
        setMake(make);
        setModel(model);
        setOs(os);
